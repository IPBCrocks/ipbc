...
* Running IPBC node, linked to private/public testnet. 
  By default, tests expect daemon running at ```localhost:34181```,
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/ipbc/testnet_pvt```. 
